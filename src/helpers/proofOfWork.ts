...
export class ProofOfWork {
     ...
     */
    public async pow(trunkTransaction: string, branchTransaction: string, minWeightMagnitude: number,
                     trytes: string[], progressCb: (tryteIndex: number) => void): Promise<string[]> {
